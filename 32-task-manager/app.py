...
def mark_completed():
    try:
        ...
        messagebox.showwarning(
            "Warning", "Please select a task to mark as completed!")
...
task_listbox = tk.Listbox(list_frame, width=45, height=12, font=("Arial", 12),
...
complete_button = tk.Button(
    button_frame, text="Mark as Completed", command=mark_completed)
